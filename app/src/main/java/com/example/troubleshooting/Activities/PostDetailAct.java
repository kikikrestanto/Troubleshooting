...
import com.example.troubleshooting.Adapters.AdapterComments;
import com.example.troubleshooting.Models.ModelComment;
...
public class PostDetailAct extends AppCompatActivity {
    ...
    String hisUid, myUid, myEmail, myName, myDp,
            postId, pLikes, hisDp, hisName, pImage, commentCount,fullImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pImageIv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent gotoFullImage = new Intent(PostDetailAct.this, ImageViewAct.class);
                intent.putExtra("pImage",fullImage);
                startActivity(gotoFullImage);
            }
        });
    }
